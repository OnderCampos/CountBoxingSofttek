...
def create_faces(boxes: list) -> list:
    """Build a list of Boxface objects from raw box dictionaries."""
    return [
        Boxface(
            int(box["x1"]),
            int(box["y1"]),
...
def get_sides(tower_path: str) -> tuple:
    """Load the four tower sides from their respective JSON files."""
